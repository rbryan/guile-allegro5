...
(define (al-get-blender)
  (let ((v (make-bytevector (* (sizeof int) 3)))
        (src-offset (sizeof int))
        (dst-offset (* (sizeof int) 2)))
    (%al-get-blender (bytevector->pointer v)
                     (bytevector->pointer v src-offset)
                     (bytevector->pointer v dst-offset))
    (values (bytevector->int v)
            (bytevector->int v src-offset)
            (bytevector->int v dst-offset))))

(define (al-get-separate-blender)
  (let ((v (make-bytevector (* (sizeof int) 6)))
        (src-offset (sizeof int))
        (dst-offset (* (sizeof int) 2))
        (alpha-op-offset (* (sizeof int) 3))
        (alpha-src-offset (* (sizeof int) 4))
        (alpha-dst-offset (* (sizeof int) 5)))
    (%al-get-separate-blender (bytevector->pointer v)
                              (bytevector->pointer v src-offset)
                              (bytevector->pointer v dst-offset)
                              (bytevector->pointer v alpha-op-offset)
                              (bytevector->pointer v alpha-src-offset)
                              (bytevector->pointer v alpha-dst-offset))
    (values (bytevector->int v)
            (bytevector->int v src-offset)
            (bytevector->int v dst-offset)
            (bytevector->int v alpha-op-offset)
